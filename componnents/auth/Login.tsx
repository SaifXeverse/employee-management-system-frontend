      ...
      <section className="flex items-center justify-center px-6 py-10">
        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-2">
            ...
            <button className="h-14 mt-3 w-full rounded-xl bg-linear-to-r from-violet-600 to-blue-600 font-semibold text-white transition hover:shadow-lg">
              Login
            </button>
          ...
          <p className="text-center mt-4 text-slate-500">
            ...
            <Link  prefetch={false} href="/register" className="font-semibold text-violet-600">
              Register
            </Link>
          </p>
        </div>
