      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg">
        <div className="bg-linear-to-r from-violet-600 via-indigo-600 to-blue-600 px-6 py-8">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-full border-4 border-white bg-white text-3xl font-bold text-violet-700 shadow-xl">
            ...
            <span className="mt-4 rounded-full bg-white/20 px-4 py-1.5 text-sm font-medium text-white backdrop-blur">
              {inputs.department}
            </span>
          </div>
        </div>
