                ...
                >
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-r from-violet-600 to-blue-600 text-sm font-bold text-white">
      ...
      <div className="space-y-4 p-4 md:hidden">
        {filteredEmployees.length === 0 ? (
          ...
          filteredEmployees.map((employee) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-full bg-linear-to-r from-violet-600 to-blue-600 text-sm font-bold text-white">
                  {employee.name.charAt(0).toUpperCase()}
                </div>
