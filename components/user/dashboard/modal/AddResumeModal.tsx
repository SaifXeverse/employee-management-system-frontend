      ...
      <DialogTrigger
        render={
          <button className="cursor-pointer rounded-2xl border border-slate-200 bg-white p-6 text-left shadow-md transition-all duration-300 hover:-translate-y-2 hover:border-blue-500 hover:shadow-xl">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#1b388a]">
        ...
        <div className="space-y-5">
          ...
          {resume.resume! ? (
            ...
            >
              ...
              <div>
                <p className="font-medium text-slate-800">{resume.resumeId!}</p>
              </div>
            </Link>
          ) : (
            <></>
          ...
          <DialogClose
            render={
              <button
                ...
                disabled={loading}
                className="cursor-pointer flex items-center gap-2 rounded-xl bg-[#1c3059] px-6 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:bg-[#16284b] disabled:cursor-not-allowed disabled:opacity-75"
              >
